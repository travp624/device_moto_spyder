...
# omapzoom prebuilts
PRODUCT_COPY_FILES += \
    device/moto/spyder/prebuilt/etc/firmware/ducati-m3.bin:/system/etc/firmware/ducati-m3.bin \
    device/moto/spyder/prebuilt/vendor/lib/hw/gralloc.omap4.so:/system/vendor/lib/hw/gralloc.omap4.so \
